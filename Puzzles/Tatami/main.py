from Puzzles.common import analyze_horizontal_line, analyze_vertical_line, process_pixel_long_results, process_pixel_short_results, recognize_digits, level_node_string
...
def main():
    level_image_path = "~/Documents/Programs/Games/100LG/Tatami/"
