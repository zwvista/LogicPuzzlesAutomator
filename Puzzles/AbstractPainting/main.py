...
from Puzzles.puzzle_analyzer import PuzzleAnalyzer, process_pixel_short_results, to_base_36
...
class _Analyzer(PuzzleAnalyzer):
    ...
    def __init__(self: Self):
        super().__init__(
            250,
            [(1, 4), (11, 5), (31, 6), (51, 7), (101, 8), (151, 9), (191, 10)]
        )
    ...
    def format_matrix_with_walls2(
        ...
        for r in range(rows + 1):
            ...
            for c in range(cols + 1):
                ...
                if c == cols: break
                line.append(' ')
            lines.append(''.join(line) + to_base_36(digits[cols]) + '`')
        digits = matrix[rows]
        line = []
        for c in range(cols):
            line.append(' ')
