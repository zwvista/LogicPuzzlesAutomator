...
class _Analyzer(PuzzleAnalyzer):
    ...
    YELLOW_PATH = '../../images/nav_plain_yellow.png'
    template_img_4channel_list = get_template_img_4channel_list(RED_PATH, GREEN_PATH, YELLOW_PATH)

    def __init__(self: Self):
        super().__init__(
            400,
            [(1, 5), (11, 6), (31, 7), (71, 8), (181, 9), (271, 10), (361, 11)]
        )
