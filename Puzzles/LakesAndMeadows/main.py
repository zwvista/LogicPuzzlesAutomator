...
class _Analyzer(PuzzleAnalyzer):
    ...
    LAKE_PATH = '../../images/ice_hole.png'
    template_img_4channel_list = get_template_img_4channel_list(LAKE_PATH)

    def __init__(self: Self):
        super().__init__(
            200,
            [(1, 5), (21, 6), (41, 7), (71, 8), (101, 9), (141, 10), (181, 11)]
        )
