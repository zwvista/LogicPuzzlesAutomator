...
class _Analyzer(PuzzleAnalyzer):
    ...
    SIGN_PATH = '../../images/sal_signpost.png'
    UP_PATH = '../../images/sal_up.png'
    RIGHT_PATH = '../../images/sal_right.png'
    DOWN_PATH = '../../images/sal_down.png'
    LEFT_PATH = '../../images/sal_left.png'
    template_img_4channel_list = get_template_img_4channel_list(SIGN_PATH, UP_PATH, RIGHT_PATH, DOWN_PATH, LEFT_PATH)

    def __init__(self: Self):
        super().__init__(
            400,
            [(1, 5), (11, 6), (21, 7), (101, 9), (281, 10)]
        )
...
if __name__ == "__main__":
    analyzer = _Analyzer()
    # analyzer.take_snapshot(app_series_no=4, start_level=249)
